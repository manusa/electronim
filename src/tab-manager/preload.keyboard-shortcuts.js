...
EVENTS.set(eventKey({key: 'r', metaKey: true}), () => ipcRenderer.send(APP_EVENTS.reload));
EVENTS.set(eventKey({key: 'f', metaKey: true}), () => ipcRenderer.send(APP_EVENTS.findInPageOpenWindow));
EVENTS.set(eventKey({key: 'F', metaKey: true}), () => ipcRenderer.send(APP_EVENTS.findInPageOpenWindow));
EVENTS.set(eventKey({key: 'f', ctrlKey: true}), () => ipcRenderer.send(APP_EVENTS.findInPageOpenWindow));
EVENTS.set(eventKey({key: 'F', ctrlKey: true}), () => ipcRenderer.send(APP_EVENTS.findInPageOpenWindow));
