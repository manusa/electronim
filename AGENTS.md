...
### Testing
- `npm test` - Run full test suite - takes ~10 seconds, runs 1219 tests (64 test suites). NEVER CANCEL - Set timeout to 30+ minutes.
...
- **Test suite** (`npm test`): ~10 seconds (1219 tests, 64 test suites)
